...
========================================== */
  ...
  return (
    <section className="ownvehicle-page">
      ...
      <header className="ownvehicle-header">
        <div className="header-left">
          <h2>Own Vehicle Details</h2>

          <p>
            Manage and monitor all
            company-owned vehicle records.
          </p>
        </div>
